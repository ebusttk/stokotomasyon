...
public class musteri_urun_ara {
    ...
    private void initialize() {
        ...
        textArea.setBounds(140, 110, 150, 100);
        frame.getContentPane().add(textArea);
        textArea.setEditable(false);


        btnNewButton_1 = new JButton("MÜŞTERİ MENÜ");
        btnNewButton_1.setBounds(140, 223, 150, 23);
        frame.getContentPane().add(btnNewButton_1);


        musteri_urun_ara.Butonu_dinle bt_dinle = new musteri_urun_ara.Butonu_dinle();
        btnNewButton.addActionListener(bt_dinle);

        musteri_urun_ara.Butonu_dinle bt_dinle2 = new musteri_urun_ara.Butonu_dinle();
